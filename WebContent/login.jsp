<%@ page language="java" contentType="text/html; charset=utf-8"
    pageEncoding="utf-8"%>
<%@ page import="com.yulong.model.Admin" %>
<%@ page import="com.yulong.model.DormManager" %>
<%@ page import="com.yulong.model.Student" %>
<%
...
<div class="container">
      <form name="myForm" class="form-signin" action="login" method="post" onsubmit="return checkForm()">
        ...
        <button class="btn btn-large btn-primary buttonS" type="submit">登录</button>
        &nbsp;&nbsp;&nbsp;&nbsp;
        <button class="btn btn-large btn-primary buttonS" type="reset" >重置</button>
      </form>
</div>
<div class="bottom">
	Copyright&nbsp;©&nbsp;yulong&nbsp;&nbsp;2018.12
</div>
</body>
</html>