...
import com.yulong.model.PageBean;
import com.yulong.model.Student;
import com.yulong.util.DbUtil;
import com.yulong.util.PropertiesUtil;
...
public class StudentServlet extends HttpServlet{
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		System.out.println("学生分页每页大小:"+pageBean.getPageSize());
		...
		try {
			...
			if("admin".equals((String)currentUserType)) {
				...
				System.out.println("系统管理员分页:"+total);
				...
				List<Student> studentList = studentDao.studentListWithBuild(con, student, buildId, pageBean);
				int total = studentDao.studentCountWithBuildId(con, student,buildId);
				System.out.println("宿舍楼管理员分页:"+total);
				String pageCode = this.genPagation(total, Integer.parseInt(page), Integer.parseInt(PropertiesUtil.getValue("pageSize")));
				request.setAttribute("pageCode", pageCode);
