...
//	}
	...
	public int recordAdd(Connection con, Record record)throws Exception {
		...
		pstmt.setInt(5, record.getDormBuildId());
		pstmt.setString(6, record.getDormBuildName());
		pstmt.setString(7, record.getDormName());
		pstmt.setString(8, record.getStartDate());
		pstmt.setString(9, record.getEndDate());
